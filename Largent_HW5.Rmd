...
Note: For all problems, unless the output var is specified by the question, the output of the variable is indicated by the first letter of the output name: v is for vector, s is for scalar. 
...
8) This problem uses the cumprod function in order to execute the proper summation. The output is a scalar.
